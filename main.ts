...
let greeting3 = ('Hasni Bro');
let greeting4 = ('Hasni Bro');
...
if (x === 10){
    ...
    const hisbox = 'apple';
    var yourbox = 'Mango';
    console.log(mybox);                  // in print = flower
...
let hatPrice = 150                            // number
console.log(`hat Price = ${hatPrice}`);       //  in print = 150

let bootPrice = '100'                         // string
console.log(`boot Price = ${bootPrice}`);     //  in print = 100
